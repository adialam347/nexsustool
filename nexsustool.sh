...
echo -e  "Tools    : Nexsus Tool $white         " |lolcat
echo -e  "Creadby  : Mrx_Nexsus $white   " |lolcat
echo -e  "Contact  : adialam347@gmail.com $white " |lolcat
echo -e
"_____________________________________________________________"
...
sleep 1
echo ""
echo -e $white"[#]> Thank for install tool :)..."
sleep 1
exit
}
...
6) echo "created by : Mrx_Nexsus" | lolcat
exit
;;
